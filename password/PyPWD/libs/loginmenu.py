...
class Ui_loginmenu(object):       
    def setupUi(self, loginmenu):
        ...
        self.msgdialog_2.setGeometry(QtCore.QRect(90, 10, 521, 31))
        font = QtGui.QFont()
